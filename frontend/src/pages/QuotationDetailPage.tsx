...
const QuotationDetailPage: React.FC = () => {
  ...
  const calculateTotalReferenceValue = () => {
    ...
    return quotation.items.reduce((total, item) => total + item.product.price * item.quantity, 0);
  };
        ...
        {quotation.items.map((item, index) => {
          ...
          return (
            <Card
              key={index}
              variant='outlined'
              sx={{ borderRadius: 2, overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.12)' }}
            >
              <Box
                sx={{
                  p: 1.5,
              ...
              >
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                  ...
                  <Box>
                    <Typography
                      variant='subtitle2'
                      sx={{ lineHeight: 1.2, fontWeight: 500, color: 'text.primary' }}
                    >
                      {item.product.name}
                    </Typography>
                    <Typography
      ...
      >
        ...
        <Box sx={{ px: 2, pb: 2, pt: 0.5 }}>
          ...
          >
            ...
            <Box
              sx={{ display: 'flex', flexDirection: 'column', gap: 0.5, alignItems: 'flex-end' }}
            >
              <Typography
                variant='caption'
              ...
              <Typography
                variant='h6'
                color='primary'
                sx={{ fontFamily: 'monospace', fontWeight: 'bold', lineHeight: 1.2 }}
              >
